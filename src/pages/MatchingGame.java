...
public class MatchingGame extends javax.swing.JPanel {
    ...
    static final HashMap<Integer, String[]> hmAnimalName = new HashMap<>();
...
//        run(ID);
    ...
    public static void run(int LANG){
        System.out.println("Running : Game page");
...
//            System.out.println(lblAnimals[i].getIcon().toString());
    ...
    private void initComponents() {
        ...
        lblChosenAnimal.setIcon(new ImageIcon(System.getProperty("user.dir")+"\\assets\\image\\1.png"));
    ...
    private void btnLangSwitchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLangSwitchActionPerformed
        ...
        frame_mg.setTitle(LANG == ID ? "Mencocokkan Gambar" : "Matching Games");
        btnBack.setText(LANG == ID ? "Kembali" : "Back");
        btnLangSwitch.setText(LANG == ID ? "Id" : "Eng");
        lblTitle.setText(LANG == ID ? "Cocokkan Hewan yang Tepat!!" : "Match the Same Animal!!");
        ...
        String[] roundstr = lblRound.getText().split(" : ");
        lblRound.setText(LANG == ID ? "Ronde : "+roundstr[1] : "Round : "+roundstr[1]);
        
        String[] correctstr = lblCorrect.getText().split(" : ");
        lblCorrect.setText(LANG == ID ? "Benar : "+correctstr[1] : "Correct : "+correctstr[1]);
        
        String[] wrongstr = lblWrong.getText().split(" : ");
        lblWrong.setText(LANG == ID ? "Salah : "+wrongstr[1] : "Wrong : "+wrongstr[1]);
...
//        g.drawImage(imgClick, xrender, yrender, 50, 50, null); // jika ingin resize image
        ...
        while(true){
            ...
            if (temp - ms >= 200){
                this.repaint(xrender, yrender, widthRepaint, heightRepaint);
//                pnlLobby.repaint(evt.getX()-25, evt.getY()-25, evt.getX()+50, evt.getY()+50);
    ...
    private void formMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMouseClicked
        System.out.printf("Mouse Clicked to Game Panel at (%d, %d)\n", evt.getX(), evt.getY());
